...
{
	128,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.RedundantParaConfig),
	0,	 	    		//min
	65535,    			//max
	0,    		  //default
	(void*)&gPara.RedundantParaConfig,
//	"Vehicle",
//	"Rsv",
};
...
{
	129,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.CANBaudrate),
	0,	 	    		//min
	1000,    			//max
	0,    		  //default
	(void*)&gPara.CANBaudrate,
//	"Vehicle",//"CAN Baudrate",
//	" ",//"CAN Baudrate. 0:default, 125:125K, 250:250K, 500:500K, 800:800K, 1000:1M",
};
...
{
	200,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[0]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	201,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[1]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	202,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[2]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	203,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[3]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	204,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[4]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	205,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[5]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	206,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[6]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
{
	207,
	PRM_ARRT_EPROM | PRM_ATTR_SIZE(gPara.ErrorTrace[7]),
	0,	 	    		//min
	1000,    		//max
	0,    		  //default
...
//				SL_SET(PLC_PARA_OV_LIMIT_ERR);
				MCL_SetFault(PARA_OV_LIMIT_ERR);
