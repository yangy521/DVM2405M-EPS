...
//	p->Filter.Out = 0;
	...
	p->TorqueFilter.In = 0;
	/* LPF1 */
	p->TorqueFilter.LPF1.x0 = 0;
	p->TorqueFilter.LPF1.x1 = 0;
	p->TorqueFilter.LPF1.x2 = 0;
	p->TorqueFilter.LPF1.y0 = 0;
	p->TorqueFilter.LPF1.y1 = 0;
	p->TorqueFilter.LPF1.y2 = 0;
	/* LPF2 */
	p->TorqueFilter.LPF2.x0 = 0;
	p->TorqueFilter.LPF2.x1 = 0;
	p->TorqueFilter.LPF2.x2 = 0;
	p->TorqueFilter.LPF2.y0 = 0;
	p->TorqueFilter.LPF2.y1 = 0;
	p->TorqueFilter.LPF2.y2 = 0;
	/* Notch1 */
	p->TorqueFilter.Notch1.x0 = 0;
	p->TorqueFilter.Notch1.x1 = 0;
	p->TorqueFilter.Notch1.x2 = 0;
	p->TorqueFilter.Notch1.y0 = 0;
	p->TorqueFilter.Notch1.y1 = 0;
	p->TorqueFilter.Notch1.y2 = 0;
	/* Notch2 */
	p->TorqueFilter.Notch2.x0 = 0;
	p->TorqueFilter.Notch2.x1 = 0;
	p->TorqueFilter.Notch2.x2 = 0;
	p->TorqueFilter.Notch2.y0 = 0;
	p->TorqueFilter.Notch2.y1 = 0;
	p->TorqueFilter.Notch2.y2 = 0;
	p->TorqueFilter.Out = 0;

//	/* reset flux filter */
//	p->FluxFilter.In = 0;
//	/* LPF1 */
//	p->FluxFilter.LPF1.x0 = 0;
//	p->FluxFilter.LPF1.x1 = 0;
//	p->FluxFilter.LPF1.x2 = 0;
//	p->FluxFilter.LPF1.y0 = 0;
//	p->FluxFilter.LPF1.y1 = 0;
//	p->FluxFilter.LPF1.y2 = 0;
//	/* LPF2 */
//	p->FluxFilter.LPF2.x0 = 0;
//	p->FluxFilter.LPF2.x1 = 0;
//	p->FluxFilter.LPF2.x2 = 0;
//	p->FluxFilter.LPF2.y0 = 0;
//	p->FluxFilter.LPF2.y1 = 0;
//	p->FluxFilter.LPF2.y2 = 0;
//	/* Notch1 */
//	p->FluxFilter.Notch1.x0 = 0;
//	p->FluxFilter.Notch1.x1 = 0;
//	p->FluxFilter.Notch1.x2 = 0;
//	p->FluxFilter.Notch1.y0 = 0;
//	p->FluxFilter.Notch1.y1 = 0;
//	p->FluxFilter.Notch1.y2 = 0;
//	/* Notch2 */
//	p->FluxFilter.Notch2.x0 = 0;
//	p->FluxFilter.Notch2.x1 = 0;
//	p->FluxFilter.Notch2.x2 = 0;
//	p->FluxFilter.Notch2.y0 = 0;
//	p->FluxFilter.Notch2.y1 = 0;
//	p->FluxFilter.Notch2.y2 = 0;
//	p->FluxFilter.Out = 0;
	...
	p->PID.OutPreSat = 0;
	p->PID.SatErr = 0;
	p->PID.KcoeTorque2Iq = _IQ(1.0);
	p->PID.KcoeIq2Torque = _IQ(1.0);
	p->PID.State = 0;
	p->EncoderDirCount = 0;

	/* reset speed observer */
	p->Observer.TaSum = 0;
	p->Observer.IqFdb = 0;
	p->Observer.SpdRaw = 0;
	p->Observer.SpdObs = 0;
	p->Observer.PID.Out = 0;
	p->Observer.PID.Ref = 0;
	p->Observer.PID.Fdb = 0;
	p->Observer.PID.Err = 0;
	p->Observer.PID.Up = 0;
	p->Observer.PID.Ui = 0;
	p->Observer.PID.OutPreSat = 0;
	p->Observer.PID.SatErr = 0;

	p->WeakFlux.FluxRefIn =  p->BaseFlux;
	p->WeakFlux.FluxRef = p->BaseFlux;
	p->WeakFlux.BaseFlux = p->BaseFlux;
	p->WeakFlux.IqCmdOut = 0;
	p->WeakFlux.IqCmdIn = 0;
	//p->WeakFlux.IqSum = (((INT64S)p->BaseFlux) << (IQSUM_SHIFT+0)) + (((INT64S)p->BaseFlux) << (IQSUM_SHIFT-1));
	p->WeakFlux.IqSum = ((INT64S)_IQmpy(p->BaseFlux,_IQ(BASEFLUX_MIN_RATIO))) << IQSUM_SHIFT;
	p->WeakFlux.IqEverage = p->WeakFlux.IqSum >> IQSUM_SHIFT;
	p->WeakFlux.State = 0;
	p->WeakFlux.SlipFreq = 0;
	p->WeakFlux.VoltageBus = p->VoltageBus;
		/* reset v limit PID */
	p->WeakFlux.PID.Out = 0;
	p->WeakFlux.PID.Ref = 0;
	p->WeakFlux.PID.Fdb = 0;
	p->WeakFlux.PID.Err = 0;
	p->WeakFlux.PID.Up = 0;
	p->WeakFlux.PID.Ui = 0;
	p->WeakFlux.PID.OutPreSat = 0;
	p->WeakFlux.PID.SatErr = 0;
	p->WeakFlux.PID.KpCoe = _IQ(1.0);
}
