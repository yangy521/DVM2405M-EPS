...
typedef struct PWM_GEN
{
	...
	INT16S MfuncC1;		/* Input: PWM 1&2 Duty cycle ratio (Q15) */
	INT16S MfuncC2;		/* Input: PWM 3&4 Duty cycle ratio (Q15) */
	INT16S MfuncC3;		/* Input: PWM 5&6 Duty cycle ratio (Q15) */
	void (*Update)(struct PWM_GEN *);	/* Pointer to the update function */
} PWM_GEN;
