...
/*********************************************************************/
	...
	if (gCRam.SvPa.MotorType != 0) 
	{
		...
		gCRam.SvPa.AcMotorTypicalSpdF = _IQrmpy(pcMotorPara->TypicalHZ,STD_FRQ*100.0);
		gCRam.SvPa.AcMotorWkBaseSpdF =_IQmpy(pcMotorPara->WkBaseHZ,STD_FRQ*100.0);
		gCRam.SvPa.AcMotorRateSpdF = _IQmpy(pcMotorPara->RatedHZ,STD_FRQ*100.0);
		gCRam.SvPa.AcMotorDeltaSpdF = _IQmpy(pcMotorPara->DeltaHZ,STD_FRQ*100.0);
		gCRam.SvPa.AcMotorDriveCurrentLimitRatio = _IQmpy(_IQdiv(pcMotorPara->DriveCurrent,_IQ(RATE_2M_CURRENT*SQRT2*PH3_TO_PH2	/STD_CURRENT)),STD_PERCENT);
		gCRam.SvPa.AcMotorUphillCurrentLimitRatio = _IQmpy(_IQdiv(pcMotorPara->UphillCurrent,_IQ(RATE_2M_CURRENT*SQRT2*PH3_TO_PH2	/STD_CURRENT)),STD_PERCENT);
		gCRam.SvPa.AcMotorRegenCurrentLimitRatio = _IQmpy(_IQdiv(pcMotorPara->RegenCurrent,_IQ(RATE_2M_CURRENT*SQRT2*PH3_TO_PH2	/STD_CURRENT)),STD_PERCENT);
		gCRam.SvPa.AcMotorBrakeCurrentLimitRatio = _IQmpy(_IQdiv(pcMotorPara->BrakeCurrent,_IQ(RATE_2M_CURRENT*SQRT2*PH3_TO_PH2	/STD_CURRENT)),STD_PERCENT);
		...
		gCRam.SvPa.WkAdjRatio = _IQmpy(pcMotorPara->WkAdjRatio, 4096);
		gCRam.SvPa.RotorTCoe = _IQmpy(pcMotorPara->RotorTCoe, 100000);
		gCRam.SvPa.TorqueCoe1 =_IQmpy(pcMotorPara->KTorque,1000.0*SQRT2*PH3_TO_PH2*STD_TORQUE_K);
		gCRam.SvPa.Inertia = _IQmpy(pcMotorPara->Inertia,10000.0*STD_INERTIA);
		gCRam.SvPa.StatorResist = _IQmpy(pcMotorPara->Resist,100000.0*STD_RESIST);
	...
	else //gCRam.SvPa.MotorType==0
	{
		...
		pMotorPara->TypicalHZ = (_iq)gCRam.SvPa.AcMotorTypicalSpdF * _IQ(1.0/(STD_FRQ*100.0));
		pMotorPara->RatedHZ = (_iq)gCRam.SvPa.AcMotorRateSpdF *  _IQ(1.0/(STD_FRQ*100.0));
		pMotorPara->WkBaseHZ = (_iq)gCRam.SvPa.AcMotorWkBaseSpdF *  _IQ(1.0/(STD_FRQ*100.0));
		pMotorPara->DeltaHZ =  (_iq)gCRam.SvPa.AcMotorDeltaSpdF *  _IQ(1.0/(STD_FRQ*100.0));
    ...
    pMotorPara->BrakeFlux = _IQmpy(pMotorPara->BrakeCurrent, (_iq)gCRam.SvPa.AcMotorFluxRatio * _IQ(1.0/STD_PERCENT));
		...
		pMotorPara->WkAdjRatio = (_iq)gCRam.SvPa.WkAdjRatio * _IQ(1.0/4096);
		...
		pMotorPara->Resist = (_iq)gCRam.SvPa.StatorResist * _IQ(1.0/(100000.0*STD_RESIST));
	...
	}
	{
		...
		pMotorPara->UphillRatioKoe = _IQdiv((_IQdiv(pMotorPara->UphillCurrent, pMotorPara->DriveCurrent) - _IQ(1.0)), (pMotorPara->WkBaseHZ>>2));
		pMotorPara->WkAdjRatioKoe = _IQdiv((pMotorPara->WkAdjRatio - _IQ(1.0)), (pMotorPara->TypicalHZ - pMotorPara->WkBaseHZ));
